...
const Channels = () => {
    ...
    */
    ...
    const { data: channelsValues, status: dataFetchStatus, isLoading: isDataLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            values.forEach((element: ChannelValues, idx: number) => {
                const result = powerMetersValues.filter((powerMeter: PowerMeterValues) => {
     ...
     */
    const [power_meterValues, setPower_meterValues] = useState<PowerMeterValues[]>([]);
    /**
        ...
        <div className="card">
                            ...
                            <>
                                <div className="grid align-items-baseline">
                                    ...
                                    <div className="col-12 md:col-10">
                                        <Dropdown id={field.name} tooltip={errors.power_meter_id?.message} className={classNames({ 'p-invalid': fieldState.invalid })} value={field.value} onChange={(event) => field.onChange(event.target.value)} options={power_meterValues} optionLabel="asset_name" optionValue="id" placeholder="Select Power meter" style={{ width: '100%' }} />
                                    </div>
                                </div>
                            </>
                        )}
            ...
            <div className="card">
                ...
                >
                    ...
                    <Column field="assset_name" header="Power meter name"></Column>
